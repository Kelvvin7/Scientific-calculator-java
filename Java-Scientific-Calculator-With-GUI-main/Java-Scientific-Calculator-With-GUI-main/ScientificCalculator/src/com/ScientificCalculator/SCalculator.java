...
public class SCalculator {
	...
	private void initialize() {
		frame = new JFrame();
		frame.getContentPane().setBackground(new Color(155, 127, 91));
		frame.setBounds(100, 100, 633, 872);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		JScrollBar scrollbar = new JScrollBar();
		scrollbar.setBackground(Color.white);
		scrollbar.setBounds(9,1,50,400);
		
		JLabel lblNewLabel = new JLabel("   SCIENTIFIC CALCULATOR BY PROMISE ONWUCHEKWA ");
